      ...
      <div>
        ...
        <div className={classes.fixedBottom}>
          <BottomNavigation
            ...
            <BottomNavigationButton label="Sort" onClick={() => this.handleNavigationChange('/sort')} icon={<SortIcon />} />
            <BottomNavigationButton label="Once" onClick={() => this.handleNavigationChange('/once')} icon={<OnceIcon />} />
            <BottomNavigationButton label="Curry" onClick={() => this.handleNavigationChange('/curry')} icon={<CurryIcon />} />
            <BottomNavigationButton label="Counter" onClick={() => this.handleNavigationChange('/counter')} icon={<CounterIcon />} />
          </BottomNavigation>
        </div>
