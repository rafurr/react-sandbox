...
import { toggleDescription } from "../reducers/once";
        ...
        <div className={classes.scrollableContainer}>
          <div className={classes.container}>
            ...
            {this.props.showDescription && (
              <div>
                <p>
                  The once function creates a version of the function that can
                  only be called one time. Repeated calls to the modified
                  function will have no effect, returning the value from the
                  original call. Useful for initialization functions, instead of
                  having to set a boolean flag and then check it later.
                </p>
