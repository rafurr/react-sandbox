      ...
      <div className={classes.root}>
        ...
        <div className={classes.scrollableContainer}>
          <div className={classes.container}>
            {showHeader && (
              <header>
                <Link className={classes.spacer} to="/">
                  Home
                </Link>
                <Link className={classes.spacer} to="/sort">
                  Sort
                </Link>
                <Link className={classes.spacer} to="/once">
                  Once
                </Link>
                <Link className={classes.spacer} to="/curry">
                  Curry
                </Link>
                <Link className={classes.spacer} to="/counter">
                  Counter
                </Link>
            ...
            <p>
              ...
              React, Redux, React Router, Material-UI and other technologies. As
              time permits, this application will be updated to use additional
            ...
            <div>
              <Button
                variant="outlined"
                color="primary"
                onClick={() => this.props.history.push("/bad-link")}
              >
